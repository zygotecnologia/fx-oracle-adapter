require "fx/adapters/oracle/connection"
require "fx/adapters/oracle/functions"
require "fx/adapters/oracle/triggers"

module Fx
  # F(x) database adapters.
  #
  module Adapters
    # Oracle adapter class to be used with F(x)
    #
    class Oracle
      # Creates an instance of the F(x) Oracle adapter.
      #
